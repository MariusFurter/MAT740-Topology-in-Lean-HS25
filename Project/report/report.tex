...
\begin{enumerate}
    ...
    \item \textbf{References.} Include references to sources for the mathematics (e.g.~textbooks or lecture notes containing full proofs) and to Lean/mathlib documentation. You should also cite Lean~4 itself (see the instructions under ``How to cite Lean" on the Lean website).
